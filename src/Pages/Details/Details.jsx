...
const Details = () => {
    ...
    return (
        <div className="mx-8 py-14">
            ...
            <div className="col-span-1 flex justify-center flex-col items-center">
              ...
              <div ref={thumbnailRef} className="keen-slider thumbnail">
                {products?.map((product, index) => (
                  <div
                    key={index}
                    className={`keen-slider__slide w-20 h-20`}
                  >
                    <img
                      src={product?.img}
            ...
            <h5 className="text-sm text-gray-700"><span className="font-semibold text-gray-800">SKU:</span> 541254</h5>
              </div>
              <div className="flex items-center gap-3">
              <h5 className="text-lg text-gray-400 font-medium line-through">$48.00</h5>
                <h5 className="text-xl mr-2 font-medium text-green-800">$35.25</h5>
                <Chip color="danger" size="sm" variant="flat">65% off</Chip>
              </div>
