...
const Error = () => {
    return (
        <div className='flex justify-center py-5 items-center flex-col gap-3 h-screen'>
            ...
            <p className='text-sm font-medium text-gray-600'>Ut consequat ac tortor eu vehicula. Aenean accumsan purus eros. Maecenas sagittis tortor at metus mollis</p>
            <Link to={"/"}>
