...
const AboutUs = () => {
  ...
  return (
    <div className="mx-8  py-9">
        ...
        Placing an order with MBB is a straightforward process. Begin by browsing our extensive selection of products across various categories, from electronics to fashion and beyond. Once you've found the items you wish to purchase, simply click on the product to view detailed information. Next, select the desired quantity and add the item to your virtual shopping cart by clicking the "Add to Cart" button. You can continue shopping or proceed to checkout. At checkout, you'll be prompted to provide your shipping address and preferred payment method. Follow the instructions to complete your purchase securely. Once your order is confirmed, you'll receive an email notification with all relevant details. Sit back, relax, and await the arrival of your MBB order!
        </AccordionBody>
      </Accordion>
      ...
      <Accordion open={open === 4} className="rounded-lg mb-2 border border-blue-gray-100 px-4">
        ...
        <AccordionBody className="pt-0 text-base font-medium text-gray-800">
        Once your order has been successfully processed and dispatched from our warehouse, you'll receive an email notification containing a tracking number and detailed instructions on how to track your package. You can use this tracking number to monitor the status of your delivery in real-time. Alternatively, you can log in to your MBB account and navigate to the "Order History" section to view the status of your order. We understand the importance of knowing exactly when your order will arrive, and we're here to provide you with the information you need to track your shipment every step of the way.
        </AccordionBody>
      </Accordion>
