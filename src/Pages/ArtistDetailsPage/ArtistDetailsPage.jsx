    ...
    <div className="mx-3 lg:mx-8 my-8">
      ...
      <div className="mt-7">
        ...
        >
          ...
          >
             {
              products?.length !== 0 ? <div className={`grid grid-cols-1 md:grid-cols-2 mt-5 px-1 lg:px-3 md:px-14  gap-6 justify-center items-center  ${location.pathname.includes("/adminDashboar")? "md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4" : "sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5"}`}>
