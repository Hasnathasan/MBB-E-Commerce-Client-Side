...
const PopularArtists = () => {
    const artists = [
        {img:person7, name: "George Arthur"}, {img:person5, name: "Henry nickls"}, {img:person3, name: "Noah-James"}, {img:person8, name: "Alfie-Jay"}, {img:person4, name: "Isaac-Lee"}, {img:person7, name: "Jonathan trod"}, {img:person6, name: "Tom James"}, {img:person1, name: "Harry potter"}, {img:person8, name: "George Arthur"}, {img:person2, name: "Henry nickls"}, {img:person5, name: "Noah-James"}, {img:person4, name: "Alfie-Jay"},
      ];
    return (
        <div className="my-16">
