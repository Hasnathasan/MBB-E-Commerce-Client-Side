                        ...
                        <View style={styles.tableContainer}>
                            ...
                            <View style={styles.row}>
                                <View>
                                    ...
                                    <Text style={styles.text}>Transaction ID: <Text style={{ color: 'green' }}>{order?.transactionId}</Text></Text>
                                    <Text style={styles.text}>Payment Method: <Text style={{ color: '#333' }}>STRIPE</Text></Text>
                                </View>
                                <View>
                                    <Text style={styles.subtitle}>Order Total</Text>
                                    <Text style={styles.text}>Subtotal: ${order?.total_price}</Text>
                                </View>
                            </View>
                            ...
                            {order?.products?.map((product, index) => (
                                <View key={index} style={styles.tableRow}>
                                    ...
                                    <Text style={styles.tableCell}>
                                        ${(product?.price?.sale_price || product?.price?.regular_price) * product?.quantity}
                                    </Text>
                                </View>
                            ))}
                        </View>
