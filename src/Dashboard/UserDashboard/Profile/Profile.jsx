  ...
  return (
    <div>
      <div className="grid grid-cols-7 gap-6 justify-center">
        <div className="border col-span-7 md:col-span-4 flex flex-col justify-center items-center gap-2 h-[278px] border-gray-300 rounded-lg">
        ...
        <div className="border col-span-7 md:col-span-3 p-7 space-y-3 border-gray-300 rounded-lg">
