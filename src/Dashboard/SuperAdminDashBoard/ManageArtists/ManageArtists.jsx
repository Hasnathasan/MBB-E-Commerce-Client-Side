...
console.log("Prison",prison);
  ...
  return (
    <>
      {
        !location.pathname.includes("/artistDetails/") ? 
          ...
          <TableBody>
            {artistsData?.map((user) => (
              <TableRow key={user._id}>
                ...
                <TableCell>
                  <Link to={`artistDetails/${user?.email}`}><Button color="success" radius="lg" className="text-white">
                    View Details
                  </Button></Link>
                </TableCell>
              </TableRow>
